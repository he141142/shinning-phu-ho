        ...
        <div className="container mx-auto p-3 space-y-6">
            <Card>
                <CardHeader className="">
                    <motion.div className="flex justify-end p-3"
                        initial={{ opacity: 0, y: 100, rotate: '180deg' }}
                        ...
                        <Button onClick={renderCalendar} className="w-[30%]">View Calendar</Button>
                    </motion.div>

                    <EditableSection title="Class Name" onSave={() => console.log("Saved")} children={
                        (isEditing) => {
                            return (
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-4">
                                ...
                                <div className="flex items-center space-x-2">
                                    ...
                                    <span className="text-sm">Current Semester: {data?.GetClassById?.semester?.semester_name || "N/A"}</span>
                                </div>
                                <div className="flex items-center space-x-2">
                                    <CalendarDays className="h-4 w-4" />
                                    <span className="text-sm">Start Date: {data?.GetClassById?.semester?.start_date || "N/A"}</span>
                                </div>
                                <div className="flex items-center space-x-2 text-gray-500">
                                    {data?.GetClassById?.description || "N/A"}
                                </div>
                            </div>
                            <div>
